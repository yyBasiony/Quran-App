...
class LogicMethods {
  static Future<PrayerTimesModel?> fetchPrayerTimes(PrayerTimesService service, String city, {BuildContext? context}) async {
    ...
    try {
      ...
      final timingsJson = jsonEncode({"Fajr": times.fajr, "Dhuhr": times.dhuhr, "Asr": times.asr, "Maghrib": times.maghrib, "Isha": times.isha});
  ...
  static Map<String, String> getNextPrayerTime(PrayerTimesModel times) {
    ...
    Map<String, String> prayers = {"Fajr": times.fajr, "Dhuhr": times.dhuhr, "Asr": times.asr, "Maghrib": times.maghrib, "Isha": times.isha};
