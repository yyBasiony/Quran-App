    ...
    return BottomAppBar(
        ...
        child: Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
              IconButton(
                  icon: Icon(provider.isPlaying ? Icons.pause_circle : Icons.play_circle, color: context.primaryColor, size: 30.sp),
              ...
              DropdownButton2<AudioModel>(
                  ...
                  items: provider.reciters.map((reciter) {
                    return DropdownMenuItem<AudioModel>(
                      value: reciter,
                      child: Text(reciter.reciterName,   style: context.textTheme.headlineSmall, overflow: TextOverflow.ellipsis),
                    );
                  }).toList(),
                  dropdownStyleData: DropdownStyleData(
                      maxHeight: 200.h, decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.r), color: context.theme.cardColor)),
