        ...
        child: Column(
          children: [
            ...
            if (provider.isLoading)
              ...
              Text('searchError'.tr(), style: TextStyle(color: Colors.red, fontSize: 14.sp))
            else if (provider.searchResults.isEmpty)
              Text('searchNoResults'.tr(), style: context.textTheme.titleSmall)
            else
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        title: Text(ayah.text, textAlign: TextAlign.right, style: context.textTheme.headlineMedium?.copyWith(fontSize: 16.sp)),
                        subtitle:
                            ayah.surah != null ? Text('[${ayah.surah}]', textAlign: TextAlign.right, style: context.textTheme.headlineMedium) : null,
                      ),
                    );
                  },
                ),
